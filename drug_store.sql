...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2019 at 12:20 PM
...
(10603, 'Kevin', 963250, 9500, 'manager'),
(10607, 'Joey', 785423, 5500, 'salesman'),
(10608, 'Min', 785428, 9700, 'manager'),
(10609, 'Stark', 632258, 9700, 'manager');
...
(4000, 'Eumovate', 'Cream', 40.50, 110),
(4001, 'Fona plus Gel', 'Cream', 160.00, 70),
(4002, 'Napa Extra', 'Tablet', 3.80, 840),
(4003, 'Finix', 'Tablet', 5.00, 770),
(4004, 'Ciprocin', 'Capsule', 15.50, 545),
(4005, 'Fexo', 'Tablet', 7.00, 540),
(4006, 'Conasyd', 'Cream', 163.00, 110),
(4007, 'Prevas', 'Capsule', 4.00, 860),
(4008, 'Omidon', 'Tablet', 2.40, 672),
(4009, 'Yamadin', 'Tablet', 4.00, 820),
(4010, 'Stamaril', 'Deep SC Injection', 1000.00, 31),
(4011, 'Qpine', 'Tablet', 3.00, 765),
...
--
ALTER TABLE `employee_info`
  MODIFY `empID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10610;

--
-- AUTO_INCREMENT for table `med_info`
--
ALTER TABLE `med_info`
  MODIFY `medId` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4025;

--
-- AUTO_INCREMENT for table `userinfo`
--
ALTER TABLE `userinfo`
  MODIFY `userId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10610;
COMMIT;
