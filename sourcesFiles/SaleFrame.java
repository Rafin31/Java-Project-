...
//import sourceFiles.repositories.*;
//import sourceFiles.classes.*;
...
public class SaleFrame extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==logout){
			...
			String fileName = "G:\\Summer18-19\\OOP1\\Project 5.0\\receipts\\"+saleIdTf.getText()+".pdf";		//a folder named receipts must be in your directory
			try
			{
