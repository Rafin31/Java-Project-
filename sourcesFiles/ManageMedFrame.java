...
class ManageMedFrame extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent a){
		if(a.getSource()==logout){
			...
			if(medIdTf.getText().equals("") || medNameTf.getText().equals("") || typeTf.getText().equals("") || unitPriceTf.getText().equals("") || quantityTf.getText().equals("")){
				...
				int quantity = mr.addedQuantity(Integer.parseInt(medIdTf.getText()),Integer.parseInt(quantityTf.getText()));
